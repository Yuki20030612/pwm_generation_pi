...
HD_PWD='C:/2021_SIP_PI/IP_blocks/pwm_generation_pi/pwm_generation_pi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_generation_pi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_generation_pi.tcl
